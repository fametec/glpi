...
/bin/mysqldump -h $MARIADB_HOST -P $MARIADB_PORT -u $MARIADB_USER -p$MARIADB_PASSWORD --single-transaction --routines --databases $MARIADB_DATABASE | gzip > /var/www/html/glpi/files/_dumps/glpi-backup-${NOW}.sql.gz
